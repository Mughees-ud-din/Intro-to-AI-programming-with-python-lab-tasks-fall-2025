...
## Overview
This repository contains the **lab task** files for the Fall 2025 course: Introduction to AI Programming with Python. Each file corresponds to one lab and includes all tasks covered in that lab.
...
- Problem statements should be written in Markdown, followed by the corresponding code solutions  
- Preserve outputs for verification  

## Notes
For improved organization, additional tasks have been maintained in a separate repository.  
[Click here to access the additional tasks](https://github.com/Mughees-ud-din/Introduction-to-AI-programming./tree/main/Lab%20Tasks)
